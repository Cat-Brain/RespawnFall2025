...
public class LevelDoor : OnTickEffect
{
    ...
    public IEnumerator BeginLevel()
    {
        ...
        playerManager.rend.sortingLayerName = playerSortingLayer;
        CloseHole();
    }
    ...
    public IEnumerator ExitLevel()
    {
        ...
        if (playerSortingLayer == "")
            playerSortingLayer = playerManager.rend.sortingLayerName;
        playerManager.rend.sortingLayerName = sortingLayer;
